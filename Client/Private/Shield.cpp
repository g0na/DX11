...
void CShield::Update_Priority(_float fTimeDelta)
{
}
...
{
	/* For Com_Model */
	if (FAILED(__super::Add_Component(ENUM_TO_UINT(LEVELID::GAMEPLAY), TEXT("Prototype_Component_Model_Player_Shield"),
...
HRESULT CShield::Bind_ShaderResources()
{
...
CGameObject* CShield::Clone(void* pArg)
{
	...
	{
		MSG_BOX("Failed to Cloned : CShield");
		Safe_Release(pInstance);
	}
