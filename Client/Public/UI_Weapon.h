...
class CUI_Weapon final : public CUIObj
{
private:
	explicit CUI_Weapon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	explicit CUI_Weapon(const CUI_Weapon& Prototype);		// 메모리 복사를 통해서 객체를 생성
