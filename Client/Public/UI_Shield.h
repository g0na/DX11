...
class CUI_Shield final : public CUIObj
{
private:
	explicit CUI_Shield(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	explicit CUI_Shield(const CUI_Shield& Prototype);		// 메모리 복사를 통해서 객체를 생성
