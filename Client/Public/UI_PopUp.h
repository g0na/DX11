...
class CUI_PopUp final : public CUIObj
{
private:
	explicit CUI_PopUp(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	explicit CUI_PopUp(const CUI_PopUp& Prototype);		// 메모리 복사를 통해서 객체를 생성
