...
class CWeapon_Boss final : public CPartObject
{
public:
...
private:
	CWeapon_Boss(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CWeapon_Boss(const CWeapon_Boss& Prototype);
	virtual ~CWeapon_Boss() = default;
...
private:
	...
	const _uint				m_iColliderCnt = 6;

private:
	const _float4x4* m_pSocketMatrix = { nullptr };

public:
	static CWeapon_Boss* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
