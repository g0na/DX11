...
class CUI_Victory final : public CUIObj
{
private:
	explicit CUI_Victory(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	explicit CUI_Victory(const CUI_Victory& Prototype);		// 메모리 복사를 통해서 객체를 생성
