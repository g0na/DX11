...
class CUI_Player_HP final : public CUIObj
{
private:
	explicit CUI_Player_HP(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	explicit CUI_Player_HP(const CUI_Player_HP& Prototype);		// 메모리 복사를 통해서 객체를 생성
