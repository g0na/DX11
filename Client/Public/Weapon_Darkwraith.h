...
class CWeapon_Darkwraith final : public CPartObject
{
public:
	...
	}WEAPON_DARKWRAITH_DESC;

private:
	CWeapon_Darkwraith(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CWeapon_Darkwraith(const CWeapon_Darkwraith& Prototype);
	virtual ~CWeapon_Darkwraith() = default;
...
public:
	static CWeapon_Darkwraith* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
